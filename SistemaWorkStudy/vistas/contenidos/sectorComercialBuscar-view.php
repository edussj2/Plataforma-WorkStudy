            ...
            <div class="contenedor-formularios mb-2">
                ...
                <div class="container-fluid">
                    <ul class="listado-panel">
                        <li>
                            <a href="<?php echo SERVERURL; ?>sectorComercialLista/" class="enlace-lista">
                        ...
                        <li>
                            <a href="<?php echo SERVERURL; ?>sectorComercialBuscar/" class="enlace-buscar activo3">
                ...
                <?php 
	                if(!isset($_SESSION['busqueda_sectorComercial']) && empty($_SESSION['busqueda_sectorComercial'])):
                ?>
                            ...
                            <div class="row justify-content-md-center">
                                <div class="col-12 col-md-6">
                                    <div class="form-group bmd-form-group">
                                        <input type="text" class="form-control" name="busqueda_sectorComercial" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,30}" id="inputSearch" maxlength="30" placeholder="¿Qué Sector Comercial estas buscando?" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <p class="text-center">
                ...
                <div class="contenedor-eliminar">
                    <form class="FormularioAjax" action="<?php echo SERVERURL;?>ajax/buscadorAjax.php" data-form="search" method="POST" autocomplete="off">
                        <input type="hidden" name="eliminar_busqueda_sectorComercial" value="1">
                        <div class="container-fluid">
                            <div class="row justify-content-md-center">
                                <div class="col-12 col-md-6">
                                    <p class="text-center" style="font-size: 20px;">
                                        Resultados de la búsqueda <strong>“<?php echo $_SESSION['busqueda_sectorComercial'];?>”</strong>
                                    </p>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="container-fluid">
                                    <div class="panel panel-info shadow mt-4">
                                        ...
                                        <?php 
                                            ...
                                            echo $inssectorComercial->paginador_sectorComercial_controlador($pagina[1],10,$_SESSION['busqueda_sectorComercial']);
                                        ?>
                                        </div>
                                    </div>
                                </div>
