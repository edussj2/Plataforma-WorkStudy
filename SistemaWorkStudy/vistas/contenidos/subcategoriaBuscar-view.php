            ...
            <div class="contenedor-formularios mb-2">
                ...
                <div class="container-fluid">
                    <ul class="listado-panel">
                        ...
                        <li>
                            <a href="<?php echo SERVERURL; ?>subcategoriaNueva/" class="enlace-nuevo ">
                                <i class="fas fa-plus"></i> &nbsp; AGREGAR
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo SERVERURL; ?>subcategoriaBuscar/" class="enlace-buscar activo3">
                ...
                <?php 
	                if(!isset($_SESSION['busqueda_subcategoria']) && empty($_SESSION['busqueda_subcategoria'])):
                ?>
                            ...
                            <div class="row justify-content-md-center">
                                <div class="col-12 col-md-6">
                                    <div class="form-group bmd-form-group">
                                        <input type="text" class="form-control" name="busqueda_subcategoria" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,30}" id="inputSearch" maxlength="30" placeholder="¿Qué subcategoría estas buscando?" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <p class="text-center">
                ...
                <div class="contenedor-eliminar">
                    <form class="FormularioAjax" action="<?php echo SERVERURL;?>ajax/buscadorAjax.php" data-form="search" method="POST" autocomplete="off">
                        <input type="hidden" name="eliminar_busqueda_subcategoria" value="1">
                        <div class="container-fluid">
                            <div class="row justify-content-md-center">
                                <div class="col-12 col-md-6">
                                    <p class="text-center" style="font-size: 20px;">
                                        Resultados de la búsqueda <strong>“<?php echo $_SESSION['busqueda_subcategoria'];?>”</strong>
                                    </p>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="container-fluid">
                                    <div class="panel panel-info shadow mt-4">
                                        <div class="panel-heading">
                                            <h3 class="panel-title"><i class="fas fa-list"></i> &nbsp; LISTA DE SUBCATEGORÍAS-CURSOS</h3>
                                        </div>
                                        ...
                                        <?php 
                                            ...
                                            echo $inssubcategoria->paginador_subcategoria_controlador($pagina[1],10,$_SESSION['busqueda_subcategoria']);
                                        ?>
                                        </div>
                                    </div>
                                </div>
