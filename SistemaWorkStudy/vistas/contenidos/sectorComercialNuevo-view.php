      ...
      <div class="contenedor-formularios mb-2">
          ...
          <div class="container-fluid">
            <ul class="listado-panel">
                ...
                <li>
                    <a href="<?php echo SERVERURL; ?>sectorComercialNuevo/" class="enlace-nuevo activo2">
                    ...
                    <div class="panel panel-agregar shadow mt-4">
                      <div class="panel-heading">
                        <h3 class="panel-title">
                          <i class="fas fa-plus"></i>&nbsp; NUEVO SECTOR COMERCIAL
                        </h3>
                      </div>
                      <div class="panel-body">
                      <form class="FormularioAjax" data-form="save" action="<?php echo SERVERURL; ?>ajax/sectorComercialAjax.php" method="POST" autocomplete="off" enctype="multipart/form-data">
                        <fieldset>
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-8">
                                  <div class="form-group">
                                    <label for="sector_comercial_nombre">
                                      Descripción <span class="asterisco">*</span>
                                    </label>
                                    <input pattern="{1,60}" class="form-control" type="text" name="sector_comercial_nombre_reg" required="" maxlength="60" id="sector_comercial_nombre">
                                  </div>
                                </div>

                                <div class="col-lg-4">
                                  <div class="form-group">
                                    <label for="sector_comercial_estado">
                                      Vigencia <span class="asterisco">*</span>
                                    </label>
                                    <select class="form-control" name="sector_comercial_estado_reg" required id="sector_comercial_estado">
