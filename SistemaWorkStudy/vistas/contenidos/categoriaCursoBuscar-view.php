...
<div class="container">
  <div class="breadcrumbs p-2">
         <a href="<?php echo SERVERURL; ?>inicioAdministrador/">Inicio</a><i class="fa fa-angle-double-right"></i><a href="<?php echo SERVERURL; ?>mantenimiento/">Mantenimiento</a><i class="fa fa-angle-double-right"></i><span>Gestión de Categorías-Curso</span>
  </div>
</div>
            ...
            <div class="contenedor-formularios mb-2">
                ...
                <div class="container-fluid">
                    <ul class="listado-panel">
                        ...
                        <li>
                            <a href="<?php echo SERVERURL; ?>categoriaCursoNueva/" class="enlace-nuevo ">
                                <i class="fas fa-plus"></i> &nbsp; AGREGAR
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo SERVERURL; ?>categoriaCursoBuscar/" class="enlace-buscar activo3">
                ...
                <?php 
	                if(!isset($_SESSION['busqueda_categoriaCurso']) && empty($_SESSION['busqueda_categoriaCurso'])):
                ?>
                            ...
                            <div class="row justify-content-md-center">
                                <div class="col-12 col-md-6">
                                    <div class="form-group bmd-form-group">
                                        <input type="text" class="form-control" name="busqueda_categoriaCurso" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,30}" id="inputSearch" maxlength="30" placeholder="¿Qué categoría estas buscando?" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <p class="text-center">
                ...
                <div class="contenedor-eliminar">
                    <form class="FormularioAjax" action="<?php echo SERVERURL;?>ajax/buscadorAjax.php" data-form="search" method="POST" autocomplete="off">
                        <input type="hidden" name="eliminar_busqueda_categoriaCurso" value="1">
                        <div class="container-fluid">
                            <div class="row justify-content-md-center">
                                <div class="col-12 col-md-6">
                                    <p class="text-center" style="font-size: 20px;">
                                        Resultados de la búsqueda <strong>“<?php echo $_SESSION['busqueda_categoriaCurso'];?>”</strong>
                                    </p>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="container-fluid">
                                    <div class="panel panel-info shadow mt-4">
                                        <div class="panel-heading">
                                            <h3 class="panel-title"><i class="fas fa-list"></i> &nbsp; LISTA DE CATEGORÍAS-CURSOS</h3>
                                        </div>
                                        ...
                                        <?php 
                                            ...
                                            echo $inscategoriaCurso->paginador_categoriaCurso_controlador($pagina[1],10,$_SESSION['busqueda_categoriaCurso']);
                                        ?>
                                        </div>
                                    </div>
                                </div>
