      ...
      <div class="contenedor-formularios mb-2">
        ...
        <div class="container-fluid">
            <ul class="listado-panel">
                <li>
                    <a href="<?php echo SERVERURL; ?>estudianteLista/" class="enlace-lista activo1">
                        <i class="far fa-list-alt"></i> &nbsp; LISTADO
                    </a>
                </li>
                <li>
                    <a href="<?php echo SERVERURL; ?>estudianteBuscar/" class="enlace-buscar">
                ...
                <div class="container-fluid">
                  <div class="panel panel-info shadow mt-4">
                    ...
                    <?php 
                          ...
                          echo $insestudiante->paginador_estudiante_controlador($pagina[1],20,"");
                      ?>
                    </div>
                  </div>
                </div>
