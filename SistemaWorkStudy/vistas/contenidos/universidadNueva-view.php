            ...
            <div class="contenedor-formularios mb-2">
                ...
                <div class="container-fluid">
                    <ul class="listado-panel">
                        ...
                        <li>
                            <a href="<?php echo SERVERURL; ?>universidadNueva/" class="enlace-nuevo activo2">
                                <i class="fas fa-plus"></i> &nbsp; AGREGAR
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo SERVERURL; ?>universidadBuscar/" class="enlace-buscar">
                                ...
                                <div class="container-fluid">
                                    <div class="panel panel-agregar shadow mt-4">
                                        ...
                                        <div class="panel-body">
                                            <form class="FormularioAjax" data-form="save" action="<?php echo SERVERURL; ?>ajax/universidadAjax.php" method="POST" autocomplete="off" enctype="multipart/form-data">
                                                <fieldset>
                                                    <legend>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <div class="form-group">
                                                                    <label for="universidad_nombre">
                                                                        Descripción <span class="asterisco">*</span>
                                                                    </label>
                                                                    <input pattern="{1,60}" class="form-control" type="text" name="universidad_nombre_reg" required="" maxlength="60" id="universidad_nombre">
                                                                </div>
                                                            </div>

                                                            <div class="col-lg-4">
                                                                <div class="form-group">
                                                                    <label for="universidad_estado">
                                                                        Vigencia <span class="asterisco">*</span>
                                                                    </label>
                                                                    <select class="form-control" name="universidad_estado_reg" required id="universidad_estado">
